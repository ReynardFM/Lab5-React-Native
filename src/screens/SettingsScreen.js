...
import { getCurrentPlatformColors, isIOS, getCurrentDarkPlatformColors } from '../utils/platform';
const SettingsScreen = () => {
    const colors = getCurrentPlatformColors();
    const dark_color = getCurrentDarkPlatformColors();
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: settings.darkMode ? dark_color.background : colors.background }]}>
            <StatusBar
            ...
            <View style={[styles.header, {
                backgroundColor: isIOS ? colors.background :
                    colors.primary
            }]}>
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View style={styles.section}>
                    <Text style={[styles.sectionTitle, { color: settings.darkMode ? dark_color.text : colors.text }]}>General</Text>
                ...
                <View style={styles.section}>
                    <Text style={[styles.sectionTitle, { color: settings.darkMode ? dark_color.text : colors.text }]}>Platform Info</Text>
                    <View style={[styles.sectionContent, { backgroundColor: '#ffffff' }]}>
                        ...
                        onPress={() => {
                            Alert.alert('Confirm', 'Reset all settings?', [
                                { text: 'Cancel', style: 'cancel' },
                                {
                                    ...
                                    onPress: () => {
                                        setSettings({
                                            notifications: true, darkMode: false, locationServices: false
                                        });
